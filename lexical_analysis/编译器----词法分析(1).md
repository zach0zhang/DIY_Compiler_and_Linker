...
## 词法分析流程图
这次实现的词法分析器完全按照下图所编写：
![image](E:/DIY_Compiler_and_Linker/lexical_analysis/md_images/lexical_analysis/lexical.png)
...
```
#### 1.3 动态字符串与动态数组存储结构图
![image](E:/DIY_Compiler_and_Linker/lexical_analysis/md_images/1.png)
...
```
#### 2.3 单词表存储结构
![image](E:/DIY_Compiler_and_Linker/lexical_analysis/md_images/2.png)
...
### 4. 词法分析
将源程序的字符串解析成一个个单词符号
![image](E:/DIY_Compiler_and_Linker/lexical_analysis/md_images/3.png)
#### 4.1 单词编码
...
```
结果：
![image](E:/DIY_Compiler_and_Linker/lexical_analysis/md_images/4.png)
